...
namespace NerdDinner.Controllers
{
    ...
    public class HomeController : Controller
    {
        public ActionResult Index()
        {
            ...
            newDinner.Title = DateTime.Now.Year.ToString() + DateTime.Now.Month.ToString() + DateTime.Now.Day.ToString() + DateTime.Now.Hour.ToString() + DateTime.Now.Minute.ToString() + DateTime.Now.Second.ToString() + DateTime.Now.Millisecond.ToString() + " Dinner";
            newDinner.Description = "Description of Another Dinner";
